function init() {
  ...
  function updateParticipants(participants) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      var detail_ele = '<div class="row user-info ' + name + '"><button type="button" name="'+name+'" class="submitButton btn btn-info col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-3 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">chat</button><hr/></div></div>';
